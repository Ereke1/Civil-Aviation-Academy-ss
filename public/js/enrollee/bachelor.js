...
function programmsFunc() {
	if (programmsInputVal() === 'Лётная эксплуатация самолётов (пилот)' || programmsInputVal() === 'Лётная эксплуатация вертолётов (пилот)' || programmsInputVal() === 'Обслуживание воздушного движения и аэронавигационное обеспечение полетов') {
	...
	} else if (citizenInputVal() === 'Резидент РК' && programmsInputVal() !== 'Лётная эксплуатация самолётов (пилот)' || citizenInputVal() === 'Резидент РК' && programmsInputVal() !== 'Лётная эксплуатация вертолётов (пилот)' || citizenInputVal() === 'Резидент РК' && programmsInputVal() !== 'Обслуживание воздушного движения и аэронавигационное обеспечение полетов') {
	...
	} else if (citizenInputVal() === 'Нерезидент РК' && programmsInputVal() !== 'Лётная эксплуатация самолётов (пилот)' || citizenInputVal() === 'Нерезидент РК' && programmsInputVal() !== 'Лётная эксплуатация вертолётов (пилот)' || citizenInputVal() === 'Нерезидент РК' && programmsInputVal() !== 'Обслуживание воздушного движения и аэронавигационное обеспечение полетов') {
