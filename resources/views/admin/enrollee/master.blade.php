        ...
        <form action="{{ route('admin.enrollee.master.index') }}">
            ...
            <div>
                ...
                <select name="programms">
                    ...
                    <option value="Логистика на транспорте (профильная магистратура)" @if ($programms === 'Логистика на транспорте (профильная магистратура)') selected @endif>Логистика на транспорте (профильная магистратура)</option>
                    <option value="Логистика на транспорте (научно-педагогическая магистратура)" @if ($programms === 'Логистика на транспорте (научно-педагогическая магистратура)') selected @endif>Логистика на транспорте (научно-педагогическая магистратура)</option>
                                        ...
                                        <div class="block">
                                            ...
                                            <select name="programms" class="block__info" id="programms">
                                                ...
                                                <option
                                                    ...
                                                    Авиационная
                                                    техника и технологии (научно-педагогическая магистратура)</option>
                                                <option value="Логистика на транспорте (профильная магистратура)"
                                                    @if ($item->programms === 'Логистика на транспорте (профильная магистратура)') selected @endif>
                                                    Логистика на транспорте (профильная магистратура)</option>
                                                <option
                                                    value="Логистика на транспорте (научно-педагогическая магистратура)"
                                                    @if ($item->programms === 'Логистика на транспорте (научно-педагогическая магистратура)') selected @endif>
                                                    Логистика на транспорте (научно-педагогическая магистратура)</option>
                                                <option
                                                    value="Летная эксплуатация летательных аппаратов и двигателей (научно-педагогическая магистратура)"
