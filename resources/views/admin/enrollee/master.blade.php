                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.enrollee.master.update', $item->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="block">
                                            ...
                                            <select name="programms" class="block__info" id="programms">
                                                ...
                                                <option
                                                    ...
                                                    Летная
                                                    эксплуатация летательных аппаратов и двигателей (профильная
                                                    магистратура)
                                                </option>
                                                <option
                                                    value="Летная эксплуатация летательных аппаратов и двигателей (научно-педагогическая магистратура)"
                                ...
                                <div class="block">
                                    <form action="{{ route('admin.enrollee.master.edit', $item->id) }}" method="GET">
                                        @csrf
                                        <input type="hidden" name="id" value="{!! $item->id !!}">
