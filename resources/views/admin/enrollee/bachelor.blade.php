        ...
        <form action="{{ route('admin.enrollee.bachelor.index') }}">
            ...
            <div>
                ...
                <select name="programms">
                    <option value=""></option>
                    <option value="Лётная эксплуатация самолётов (пилот)" @if ($programms === 'Лётная эксплуатация самолётов (пилот)') selected @endif>
                        Лётная эксплуатация
                        самолётов (пилот)</option>
                    <option value="Лётная эксплуатация вертолётов (пилот)"
                        @if ($programms === 'Лётная эксплуатация вертолётов (пилот)') selected @endif>Лётная эксплуатация
                        вертолётов (пилот)</option>
                    <option value="Обслуживание воздушного движения" @if ($programms === 'Обслуживание воздушного движения') selected @endif>
            ...
            <div>
                ...
                <select name="region">
                    ...
                    <option value="г. Нур-Султан" @if ($region === 'г. Нур-Султан') selected @endif>г. Нур-Султан (Астана)
                    </option>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.enrollee.bachelor.update', $item->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="blocks">
                                        ...
                                        <div class="block">
                                            ...
                                            <select name="programms" class="block__info">
                                                ...
                                                <option value="Лётная эксплуатация самолётов (пилот)"
                                                    @if ($item->programms === 'Лётная эксплуатация самолётов (пилот)') selected @endif>
                                                    Лётная эксплуатация самолётов (пилот)
                                                </option>
                                                <option value="Лётная эксплуатация вертолётов (пилот)"
                                                    @if ($item->programms === 'Лётная эксплуатация вертолётов (пилот)') selected @endif>
                                                    Лётная эксплуатация вертолётов (пилот)
                                                </option>
                                                <option value="Обслуживание воздушного движения"
                                                    @if ($item->programms === 'Обслуживание воздушного движения') selected @endif>
