            ...
            <div>
                ...
                <select name="programms">
                    ...
                    <option value="Технология авиационных перевозок"
                        @if ($programms === 'Технология авиационных перевозок') selected @endif>Технология авиационных перевозок</option>
                                    ...
                                    <div class="blocks">
                                        ...
                                        <div class="block">
                                            ...
                                            <select name="programms" class="block__info">
                                                ...
                                                <option value="Технология авиационных перевозок"
                                                    @if ($item->programms === 'Технология авиационных перевозок') selected @endif>
