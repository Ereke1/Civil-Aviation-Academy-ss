    ...
    <div class="filter">
        <form action="{{ route('admin.enrollee.bachelor.index') }}">
            ...
            <div>
                ...
                <select name="quota">
                    <option value=""></option>
                    <option value="Граждане с инвалидностью первой или второй группы" @if ($quota === 'Граждане с инвалидностью первой или второй группы')selected @endif>Граждане с инвалидностью первой или второй группы</option>
                    <option value="Ветераны боевых действий на территории других государств, приравненных по льготам к ветеранам ВОВ" @if ($quota === 'Ветераны боевых действий на территории других государств, приравненных по льготам к ветеранам ВОВ')selected @endif>{{ __('Ветераны боевых действий на территории других государств, приравненных по льготам к ветеранам ВОВ') }}</option>
                    <option value="Сельская молодежь, поступающая на обучение по программам, определяющим социально-экономическое развитие села" value="Сельская молодежь, поступающая на обучение по программам, определяющим социально-экономическое развитие села" @if ($quota === 'Граждане с инвалидностью первой или второй группы')selected @endif>{{ __('Сельская молодежь, поступающая на обучение по программам, определяющим социально-экономическое развитие села') }}</option>
                    <option value="Этнические казахи, не являющиеся гражданами Казахстана"  @if ($quota === 'Этнические казахи, не являющиеся гражданами Казахстана')selected @endif>{{ __('Этнические казахи, не являющиеся гражданами Казахстана') }}</option>
                    <option value="Дети-сироты и дети, оставшиеся без попечения родителей" @if ($quota === 'Дети-сироты и дети, оставшиеся без попечения родителей')selected @endif>{{ __('Дети-сироты и дети, оставшиеся без попечения родителей') }}</option>
                    <option value="Сельская молодежь, переселяющаяся в регионы, определенные правительством"  @if ($quota === 'Сельская молодежь, переселяющаяся в регионы, определенные правительством')selected @endif>{{ __('Сельская молодежь, переселяющаяся в регионы, определенные правительством') }}</option>
                    <option value="Дети из семей, в которых воспитываются четверо и более несовершеннолетних детей"  @if ($quota === 'Дети из семей, в которых воспитываются четверо и более несовершеннолетних детей')selected @endif>{{ __('Дети из семей, в которых воспитываются четверо и более несовершеннолетних детей') }}</option>
                    <option value="Дети из неполных семей, имеющих этот статус не менее трех лет"  @if ($quota === 'Дети из неполных семей, имеющих этот статус не менее трех лет')selected @endif>{{ __('Дети из неполных семей, имеющих этот статус не менее трех лет') }}</option>
                    <option value="Дети из семей, воспитывающих детей с инвалидностью"  @if ($quota === 'Дети из семей, воспитывающих детей с инвалидностью')selected @endif>{{ __('Дети из семей, воспитывающих детей с инвалидностью') }}</option>
                </select>
            </div>
            <div>
                <label for="quota">Имеется ЕНТ</label>
                <select name="quota">
                    <option value=""></option>
                                        ...
                                        <div class="block">
                                            ...
                                            <select name="programms" class="block__info">
                                                ...
                                                <option value="Авиационная безопасность и интеллектуальные системы"
                                                    @if ($item->programms === 'Авиационная безопасность и интеллектуальные системыАвиационная безопасность и интеллектуальные системы') selected @endif>Авиационная безопасность и интеллектуальные системы
                                                </option>
