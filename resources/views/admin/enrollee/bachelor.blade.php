                                    ...
                                    <div class="blocks">
                                        ...
                                        <div class="block">
                                            ...
                                            <select name="programms" class="block__info">
                                                ...
                                                <option value="Техническая эксплуатация авиационного и радиоэлектронного оборудования"
                                                    @if ($item->programms === 'Техническая эксплуатация авиационного и радиоэлектронного оборудования') selected @endif>Техническая эксплуатация систем авионики летательных аппаратов
                                                </option>
                                            </select>
                                        </div>
                                        @if (isset($item->quota))
