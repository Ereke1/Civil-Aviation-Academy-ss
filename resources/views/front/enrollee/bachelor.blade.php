            ...
            <div class="enrollee">
                <form action="{{ route('front.enrollee.bachelor.store') }}" method="POST" id="form"
                    ...
                    <div class="flex">
                        ...
                        <div class="disabled" id="haveAltynBlock">
                            <label for="haveAltyn">{{ __('Имеется Алтын Белги') }}</label>
                            <select name="haveAltyn" id="haveAltyn" onchange="haveAltynFunc()" required>
                                <option value="" disabled selected>-----</option>
                        ...
                        <div class="disabled" id="quotaBlock">
                            <label for="quota">{{ __('КВОТЫ') }}</label>
                            <select name="quota" id="quota" onchange="quotaFunc()">
                                <option value="" selected>-----</option>
                                <option value="Граждане с инвалидностью первой или второй группы">{{ __('Граждане с инвалидностью первой или второй группы') }}</option>
                                <option value="Ветераны боевых действий на территории других государств, приравненных по льготам к ветеранам ВОВ">{{ __('Ветераны боевых действий на территории других государств, приравненных по льготам к ветеранам ВОВ') }}</option>
                                <option value="Сельская молодежь, поступающая на обучение по программам, определяющим социально-экономическое развитие села">{{ __('Сельская молодежь, поступающая на обучение по программам, определяющим социально-экономическое развитие села') }}</option>
                                <option value="Этнические казахи, не являющиеся гражданами Казахстана">{{ __('Этнические казахи, не являющиеся гражданами Казахстана') }}</option>
                                <option value="Дети-сироты и дети, оставшиеся без попечения родителей">{{ __('Дети-сироты и дети, оставшиеся без попечения родителей') }}</option>
                                <option value="Сельская молодежь, переселяющаяся в регионы, определенные правительством">{{ __('Сельская молодежь, переселяющаяся в регионы, определенные правительством') }}</option>
                                <option value="Дети из семей, в которых воспитываются четверо и более несовершеннолетних детей">{{ __('Дети из семей, в которых воспитываются четверо и более несовершеннолетних детей') }}</option>
                                <option value="Дети из неполных семей, имеющих этот статус не менее трех лет">{{ __('Дети из неполных семей, имеющих этот статус не менее трех лет') }}</option>
                                <option value="Дети из семей, воспитывающих детей с инвалидностью">{{ __('Дети из семей, воспитывающих детей с инвалидностью') }}</option>
                            </select>
                        </div>
                        ...
                        <div id="programmsBlock" class="disabled">
                            ...
                            <select name="programms" id="programms" onchange="programmsFunc()" required>
                                ...
                                <option class="physic-opt not-for-11kl b067 disabled"
                                    value="Техническая эксплуатация систем авионики летательных аппаратов">
                                    {{ __('Техническая эксплуатация систем авионики летательных аппаратов') }}</option>
                                    <option class="physic-opt not-for-11kl b067 disabled"
                                    value="Техническая эксплуатация авиационного и радиоэлектронного оборудования">
                                    {{ __('Техническая эксплуатация авиационного и радиоэлектронного оборудования') }}</option>
                                ...
                                {{-- <option class="physic-opt not-for-11kl b067 disabled"
                                    ...
                                    {{ __('Обслуживание наземного радиоэлектронного оборудования аэропортов') }}</option> --}}
                                ...
                                {{-- <option class="physic-opt b067 disabled"
                                 ...
                                 <option class="physic-opt b067 disabled"
                                    value="Технология авиационных перевозок">
                                    {{ __('Технология авиационных перевозок') }}</option>
                                <option class="physic-opt for-11kl b067 disabled"
                                    value="Техническая эксплуатация авиационного и радиоэлектронного оборудования">
                                    {{ __('Техническая эксплуатация авиационного и радиоэлектронного оборудования') }}</option>
                                <option class="physic-opt b067 disabled" value="Беспилотные летательные аппараты и системы">
                                    {{ __('Беспилотные летательные аппараты и системы') }}</option>
                                <option class="physic-opt b067 disabled" value="Технология авиационных перевозок">
                                    {{ __('Технология авиационных перевозок') }}</option>
                                <option class="physic-opt b067 disabled" value="Авиационная безопасность и интеллектуальные системы">
                                        {{ __('Авиационная безопасность и интеллектуальные системы') }}</option>
                                ...
                                <option class="geogr-opt disabled b095" value="Системная интеграция наземного обслуживания">{{ __('Системная интеграция наземного обслуживания') }}</option>
                            </select>
                        </div>
