                    ...
                    <div class="flex">
                        ...
                        <div id="programmsBlock" class="disabled">
                            ...
                            <select name="programms" id="programms" onchange="programmsFunc()" required>
                                ...
                                <option class="physic-opt disabled" value="Обслуживание воздушного движения и аэронавигационное обеспечение полетов">{{ __('Обслуживание воздушного движения и аэронавигационное обеспечение полетов и аэронавигационное обеспечение полетов (авиадиспетчер)') }}
                                </option>
