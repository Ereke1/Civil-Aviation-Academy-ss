                    ...
                    <ul id="myTab" role="tablist"
                        ...
                        <li class="nav-item flex-sm-fill">
                            ...
                            <a id="profile-tab" data-toggle="tab" href="#center2" role="tab" aria-controls="profile"
                                aria-selected="false" class="nav-link border-0 text-uppercase font-weight-bold">{{ __('ЦПиТАП') }}</a>
                        </li>
                        <li class="nav-item flex-sm-fill">
                            ...
                            <a id="contact-tab" data-toggle="tab" href="#center3" role="tab" aria-controls="contact"
                                aria-selected="false" class="nav-link border-0 text-uppercase font-weight-bold">{{ __('АЦ IATA') }}</a>
                        </li>
                        <li class="nav-item flex-sm-fill">
