                ...
                <div class="p-5 bg-white rounded shadow mb-5">
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div id="center2" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-4 py-5">
                            <p>{!! __('Центр подготовки авиационного персонала (ЦПАП) образован в марте 2022 года. Наш центр имеет широкий спектр курсов теоретической и практической подготовки. Квалифицированные инструкторы, а также приглашенные специалисты с удовольствием поделятся со своим опытом в сфере гражданской авиации. С 1 марта 2024 года Центр тестирования и ОВД был объединен с ЦПАП, теперь он называется - Центр подготовки и тестирования авиационного персонала (ЦПиТАП). На данный момент наш центр так же проводит обучения и тестирования по EALTS, ATPL, PART 147. В нашем центре вы можете пройти тестирование для определения уровня владения авиационным английским языком по шкале ИКАО. Тестирование проводится с использованием системы :elpac, разработанной и администрируемой компанией EUROCONTROL. Система полностью соответствует требованиям Документа ИКАО 9835 «Руководство по внедрению требований ИКАО к владению языком» и официально одобрена ICAO и EASA.', [
                                'elpac' => '<a href="https://www.eurocontrol.int/service/language-proficiency-requirements" target="_blank">ELPAC</a>'
                            ]) !!}</p>
                        </div>
