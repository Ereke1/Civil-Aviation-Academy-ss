                ...
                <div class="p-5 bg-white rounded shadow mb-5">
                    ...
                    <ul id="myTab" role="tablist"
                        ...
                        <li class="nav-item flex-sm-fill">
                            ...
                            <a id="profile-tab" data-toggle="tab" href="#center2" role="tab" aria-controls="profile"
                                aria-selected="false"
                                class="nav-link border-0 text-uppercase font-weight-bold">{{ __('ЦПАП') }}</a>
                        </li>
                        {{-- <li class="nav-item flex-sm-fill">
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div id="center2" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-4 py-5">
                            <p>{{ __('Центр подготовки авиационного персонала (ЦПАП) образован в марте 2022 года. Наш центр имеет широкий спектр курсов теоретической и практической подготовки. Квалифицированные инструкторы, а также приглашенные специалисты с удовольствием поделятся со своим опытом в сфере гражданской авиации. В центре тестирования так же проводят обучения и тестирования по EALTS, TEC, ATPL, PART 147.') }} </p>
                            <p>{!! __('Вы можете пройти тестирования для определения уровня владения авиационным английским языком по шкале ИКАО. Тестирования проводится с использованием систем :elpac и :tec, разработанными и администрируемыми компаниями EUROCONTROL и THE ENGLISH CENTRE соответственно. Системы полностью соответствуют требованиям Документа ИКАО 9835 «Руководство по внедрению требований ИКАО к владению языком» и официально одобрена ICAO и EASA.', [
                                'elpac' => '<a href="https://elpac.eurocontrol.int/" target="_blank">ELPAC</a>',
                                'tec' => '<a href="https://caa.edu.kz/the-english-centre-tec-odobrennyy-test-po-aviacionnomu-angliyskomu-yazyku-510" target="_blank">TEC</a>'
                            ]) !!}</p>
                        </div>
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        <p>
                            ...
                            @else
                            <a href="https://caa.edu.kz/assets/images/upload/ УЦАБ ИКАО на региональные курсы на русском языке_1739942589.docx">
                                ICAO ASTC Application for Regional Courses
                            </a>
                            @endif
                        </p><br>
                        <p>
                            ...
                            @else
                            <a href="https://caa.edu.kz/assets/images/upload/ УЦАБ ИКАО на региональные курсы на русском языке_1739942589.docx">
                                ICAO ASTC Reference Information
                            </a>
                            @endif
                        </p><br>
                        {{-- <p>
                        ...
                        <p>
                            ...
                            <a href="https://elpac.eurocontrol.int/prepare_test.html">
                                Формат тестирования ELPAC
                            </a>
                           @elseif(Config::get('app.locale') === 'kk')
                            <a href="https://elpac.eurocontrol.int/prepare_test.html">
                                ELPAC тестілеу форматы
                            </a>
                            @else
                            <a href="https://elpac.eurocontrol.int/prepare_test.html">
                                The ELPAC testing format
                            </a>
                            @endif
                        </p><br>
                        <p>
                            @if (Config::get('app.locale') === 'ru')
                            <a href="https://englishcentre.eu/sampleTest">
                                Формат тестирования TEC
                            </a>
                           @elseif(Config::get('app.locale') === 'kk')
                            <a href="https://englishcentre.eu/sampleTest">
                                TEC тестілеу форматы
                            </a>
                            @else
                            <a href="https://englishcentre.eu/sampleTest">
                                The TEC testing format
                            </a>
                            @endif
                        </p><br>
                        <p>
                            @if (Config::get('app.locale') === 'ru')
                            <a href="https://caa.edu.kz/storage/documents/Политика%20конфиденциальности%20TEC.pdf">
                                Политика конфиденциальности
                            </a>
                           @elseif(Config::get('app.locale') === 'kk')
                            <a href="https://caa.edu.kz/storage/documents/Құпиялылық%20саясаты%20TEC.pdf">
                                Құпиялылық саясаты
                            </a>
                            @else
                            <a href="https://caa.edu.kz/storage/documents/Политика%20конфиденциальности%20TEC.pdf">
