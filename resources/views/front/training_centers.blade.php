                ...
                <div class="p-5 bg-white rounded shadow mb-5">
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div id="center2" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-4 py-5">
                            <p>{{ __('Центр подготовки авиационного персонала (ЦПАП) образован в марте 2022 года. Наш центр имеет широкий спектр курсов теоретической и практической подготовки. Квалифицированные инструкторы, а также приглашенные специалисты с удовольствием поделятся со своим опытом в сфере гражданской авиации. С 1 марта 2024 года Центр тестирования и ОВД был объединен с ЦПАП, теперь он называется - Центр подготовки и тестирования авиационного персонала (ЦПАП). На данный момент наш центр так же проводит обучения и тестирования по EALTS, ATPL, PART 147.') }} </p>
                            <p>{!! __('В нашем центре вы можете пройти тестирования для определения уровня владения авиационным английским языком по шкале ИКАО. Тестирования проводится с использованием систем :elpac и :tec, разработанными и администрируемыми компаниями EUROCONTROL и THE ENGLISH CENTRE соответсвенно. Системы полностью соответствуют требованиям Документа ИКАО 9835 «Руководство по внедрению требований ИКАО к владению языком» и официально одобрена ICAO и EASA.', [
